  ...
  return (
    <section className="py-14 w-[100vw] ">
      <div className="mx-auto max-w-[1152px] w-[90%]">
        <h2 className="text-[#1B2559] xl:text-[26px] text-[26px] sm:text-[19px]  ml-2 font-geologica lg:mb-10 mb-5 text-left">Why Use Prodloop?</h2>
        <div className="flex-col flex sm:flex-row md:justify-around items-center w-full gap-8 ">
