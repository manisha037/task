      ...
      <div className='w-[95vw] max-w-[1152px] mx-auto flex flex-col gap-5 '>
        ...
        <div className='flex justify-around items-center flex-col gap-5 sm:flex-row'>
          ...
          <div className='flex flex-col gap-3 items-center w-full lg:w-auto'>
            <div className='border-[1.5px] border-[#7252FF] rounded-full flex gap-2 justify-center items-center xl:h-[38px] h-[36px] w-[90%] xl:w-[370px]'>
              <p className='text-[#4318FF] xl:text-[16px] md:text-[16px] text-[14px] font-medium'>Get Started for Free</p>
              <ArrowOutwardIcon className=' text-[#4318FF] text-[20px]' />
            </div>
            <div className='xl:text-[16px] md:text-[16px] text-[14px] font-bold border-[1.5px] text-white rounded-full justify-center items-center bg-[#4318FF] border-[#7252FF] flex gap-2 xl:h-[38px] h-[36px] w-[90%] xl:w-[370px]'>
