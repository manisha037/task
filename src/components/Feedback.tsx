      ...
      <div className='w-[95%] mx-auto flex flex-col gap-5 '>
        ...
        <div className='flex justify-around items-center flex-col gap-5 lg:flex-row'>
          <div className='flex flex-col lg:w-[60%] w-full gap-3'>
            ...
            <p className='md:text-[22px] text-[15px] md:leading-[32px] leading-[24px]  text-[#1B2559CC]'>Supercharge your product and customer experience teams to generate feedback insights in minutes, not hours</p>
          </div>
