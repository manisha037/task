...
const Card = ({percentage,mainheading,subheading}:{percentage:string,mainheading:string,subheading:string}) => {
  return (
           <div className=" rounded-[24px] shadow-[#0E09581A] w-[95%]  lg:w-[400px] md:h-[280px] lg:h-[384px] shadow-[0px_4px_20px_rgba(0,0,0,0.1)] flex flex-col justify-around  px-4 py-2 ">
            ...
            <p className="lg:text-[21px] text-[15px] lg:leading-[32px] leading-[20px] text-[#1B2559CC] line-clamp-4"> {subheading}
            </p>
          </div>
  )
}
